...
export const fr = {
  ...
  cadre: {
    ...
    title: "Le Cadre",
    subtitle:
      "Règles typées → skills (paquets) → templates d'agents → agents nommés dans une team.",
    scope: "Portée",
    layersAria: "Couches du cadre",
    layer: {
      rules: "Règles",
      skills: "Skills",
      templates: "Templates",
    ...
    rulePlaceholder: "Décris la règle (ex. jamais git push --force)",
    skillName: "Nom du skill",
    skillPlaceholder: "Nom du skill (ex. Git sûr)",
    nRules: "{{count}} règle(s)",
    pickRules: "Règles de ce paquet",
    noRulesYet: "Crée d'abord des règles.",
    templateName: "Nom du template",
    templatePlaceholder: "Nom du type d'agent (ex. Développeur)",
    nSkillsRules: "{{skills}} skill(s) · {{rules}} règle(s)",
    pickSkills: "Skills du template",
    noSkillsYet: "Crée d'abord des skills.",
    agentName: "Nom de l'agent",
    agentPlaceholder: "Nom dans la team (ex. Gimli)",
    chooseTemplate: "Template…",
    needTemplate: "Crée d'abord un template pour ajouter un agent.",
    unknownTemplate: "template inconnu",
    nExtras: "{{count}} en plus",
    projectHint: "Règles à portée projet (cochées) :",
